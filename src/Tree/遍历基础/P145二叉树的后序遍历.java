...
public class P145二叉树的后序遍历 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(postorderTraversalDFS(node));
    }
    ...
    public static List<Integer> postorderTraversalBFS(TreeNode root) {
        List<Integer> res = new ArrayList<>();
        Deque<TreeNode> stack = new LinkedList<>();
        if (root != null) {
            stack.push(root);
        ...
        while (!stack.isEmpty()) {
            ...
            // 头插法，从前插入0位置，根先进队列，右再进队列，左最后进队列，最后顺序就是左右根
            res.add(0, node.val);
            if (node.left != null) {
