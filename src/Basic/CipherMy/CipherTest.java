...
public class CipherTest {
    ...
    public static void main(String[] args) throws Exception{
        AESEncode("chenjunlin");
        AESDecode("ADr4A713V8i/iotWefez7w==");
//        System.out.println(aesEncryptToBytes("junlin","123456"));
//        byte[] encode = "[B@77f03bb1".getBytes();
//        System.out.println(aesDecryptByBytes(encode,"123456"));
    }
    /**
     * 加密
     * 1.构造密钥生成器
